        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-secondary-600 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/25">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/jobs" className="text-slate-400 hover:text-primary-400 transition-colors text-sm">
                  Browse Jobs
                </Link>
              </li>
              <li>
                <Link to="/register?role=recruiter" className="text-slate-400 hover:text-primary-400 transition-colors text-sm">
                  Post a Job
                </Link>
              </li>
              <li>
                <Link to="/dashboard" className="text-slate-400 hover:text-primary-400 transition-colors text-sm">
                  Candidate Dashboard
                </Link>
              </li>
            </ul>
